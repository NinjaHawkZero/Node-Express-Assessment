...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2021-09-16T03:54:42.542435" />
  ...
  <link href="/media/css/fontawesome.css?653a457c" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?653a457c">
  ...
  <body>
    <div class="container-fluid">
      ...
      <div class="row justify-content-center pg-shout-box">
        <div class="col text-white text-center">12th August 2021: <a href="https://www.postgresql.org/about/news/postgresql-134-128-1113-1018-9623-and-14-beta-3-released-2277/">
  PostgreSQL 13.4, 12.8, 11.13, 10.18, 9.6.23, and 14 Beta 3 Released</a>!
  ...
  <div class="row">
    ...
    <div class="col-lg-6 feature">
      ...
      <div class="text">
        <p>
          <strong>
            2021-08-12 - PostgreSQL 13.4, 12.8, 11.13, 10.18, 9.6.23, and
            14 Beta 3 Released!
          </strong>
        </p>
        <p>
          The PostgreSQL Global Development Group has
          <a href="/about/news/postgresql-134-128-1113-1018-9623-and-14-beta-3-released-2277/">released an update</a>
          to all supported versions of our database system, including 13.4, 12.8,
          11.13, 10.18, and 9.6.23, as well as the third beta release of
          PostgreSQL 14. This release closes
          <a href="/support/security/">one security vulnerability</a> and
          <a href="/docs/release/">fixes over 75 bugs</a> reported over the last
          three months.
        </p>
        <p>
          PostgreSQL 9.6 will stop receiving fixes on November 11, 2021. If you
          are running PostgreSQL 9.6 in a production environment, we suggest
        ...
        <p>
          ...
          exist. While we do not advise you to run PostgreSQL 14 Beta 3 in your
          production environments, we encourage you to find ways to run your
          typical application workloads against this beta release.
        </p>
        <ul>
          
            <li class=""><strong>13.4</strong> &middot; 2021-08-12 &middot; <a href="/docs/13/release-13-4.html">Notes</a></li>
          
            <li class="pg-bg-gray"><strong>12.8</strong> &middot; 2021-08-12 &middot; <a href="/docs/12/release-12-8.html">Notes</a></li>
          
            <li class=""><strong>11.13</strong> &middot; 2021-08-12 &middot; <a href="/docs/11/release-11-13.html">Notes</a></li>
          
            <li class="pg-bg-gray"><strong>10.18</strong> &middot; 2021-08-12 &middot; <a href="/docs/10/release-10-18.html">Notes</a></li>
          
            <li class=""><strong>9.6.23</strong> &middot; 2021-08-12 &middot; <a href="/docs/9.6/release-9-6-23.html">Notes</a></li>
  ...
  <div class="row">
    <div class="col-lg-7">
      ...
      <!-- Featured Post -->
        <header>
          <h3>
            <a href="/about/news/postgresql-134-128-1113-1018-9623-and-14-beta-3-released-2277/">
              PostgreSQL 13.4, 12.8, 11.13, 10.18, 9.6.23, and 14 Beta 3 Released
            </a>!
          </h3>
          <ul class="meta">
            <li><i class="far fa-clock"></i>&nbsp;2021-08-12</li>
        ...
        <ul class="bold">
          <li><a href="/about/news/postgresql-134-128-1113-1018-9623-and-14-beta-3-released-2277/">Release Announcement</a></li>
          <li><a href="/docs/release/">Release Notes</a></li>
          <li><a href="/docs/14/release-14.html">PostgreSQL 14 Beta Release Notes</a></li>
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/call-for-members-for-the-community-code-of-conduct-committee-extended-2300/">Call for Members for the Community Code of Conduct Committee Extended</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-09-15 by PostgreSQL Code of Conduct Committee</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-september-12-2021-2301/">PostgreSQL Weekly News - September 12, 2021</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-09-13 by PWN</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/trademark-actions-against-the-postgresql-community-2302/">Trademark Actions Against the PostgreSQL Community</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-09-13 by PostgreSQL Global Development Group</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pg_dumpbinary-v25-released-2298/">pg_dumpbinary v2.5 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-09-09 by Gilles Darold</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgagroal-130-2297/">pgagroal 1.3.0</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-09-07 by Red Hat</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5a8"> Logical Replication Improvements In PostgreSQL-14</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5a7"> How percentile approximation works (and why it&amp;#x27;s more useful than averages)</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;David Kohn</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-09-14</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5a6"> Respecting the majority, questioning the status quo as a minority</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5a5"> PostgreSQL: Create indexes after bulk loading</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5a4"> Soumyadeep Chakraborty</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Andreas &#39;ads&#39; Scherbaum</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-09-13</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/59_"> bugfix release of pspg - 5.3.5</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5a3"> Postgres Core Team launches unprecedented attack against the Postgres Community</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Álvaro Hernández</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-09-11</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/59-"> PostGIS 3.2.0alpha1 Released</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/59Z"> RDS, Aurora Release Dates</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;brian davis</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-09-10</li>
            </ul>
          </div>
        </div>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?653a457c"></script>
